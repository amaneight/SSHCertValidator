#
# Author : Aman Sehgal
# Timestamp : Mar 30, 2016 | 2:21:27 PM 
#
#! /usr/bin/python
...
#--------------------------------CFG INPUT--------------------------------
  ...
  def update_config(self,config, file_name):
      try:
          f = open(file_name, "wb")
          f.write(config.SerializeToString())
          self.logger.info("Configuration updated in " + file_name)
      except Exception as e:
          self.logger.error("Error updating configuration. " + e.message)
          return False
      finally:
          f.close()    
      return True
  ...
  def update_default_config(self):
      ...
      try:
          ...
          self.update_config(config, file_name)
      except Exception as e:
          self.logger.error("Error updating default configuration. " + e.message)
          return False
