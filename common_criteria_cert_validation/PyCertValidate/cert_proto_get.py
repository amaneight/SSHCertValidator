...
class GetCertConfig(object):
  ...
  def __init__(self):    
    ...
    self.cert_age = cert.cert_age
    self.trust_store_path = cert.trust_store_path
    ...
    self.preferred_mechanism = cert.preferred_mechanism
    self.fail_status = cert.fail_status  
